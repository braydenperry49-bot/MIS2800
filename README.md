...
A comprehensive stock analysis tool that combines five valuation methods into a single weighted fair-value estimate and exports a formatted Excel report.

### Valuation Methods

| Method | Weight | Description |
|---|---|---|
| DCF (Discounted Cash Flow) | 35% | Projects free cash flows and discounts to present value using WACC |
| Comparable Companies | 25% | Relative valuation using peer-company multiples (P/E, EV/EBITDA, P/S, PEG, P/B) |
...
- **Excel** (`output/` folder): A multi-sheet workbook containing:
  ...
  - Valuation Breakdown comparing all five methods
  - DCF Analysis detail (assumptions, projected FCFs, terminal value)
...
| `config.py` | API keys, valuation weights, DCF defaults, formatting constants |
